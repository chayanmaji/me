...
const skills = [
  ...
  { name: "Media Query", level: 75, category: "frontend" },
  { name: "Styled Component", level: 75, category: "frontend" },
  ...
  { name: "ASP.NET", level: 65, category: "backend" },
  ...
  { name: "Dynatrace", level: 60, category: "tools" },
  { name: "Splunk", level: 60, category: "tools" }
];
